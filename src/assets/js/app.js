...
var App = function () {
  ...
  function s() {
    ...
    n.length > 0 && ($(".be-toggle-right-sidebar").on("click", function (t) {
      r && i.hasClass(e.openRightSidebarClass) ? a() : r || (i.addClass(e.openRightSidebarClass + " " + e.transitionClass),
        r = !0),
        t.preventDefault()
    }),
  ...
  return {
    ...
    init: function (u) {
      ...
      $.extend(e, u),
        ...
        e.enableLeftSidebar ? function () {
          var t, n, l = $(".sidebar-elements > li > a", o), s = $(".sidebar-elements li a", o),
            d = $(".left-sidebar-scroll", o), p = $(".left-sidebar-toggle", o), u = !!e.openLeftSidebarOnClick;
          ...
          function m(t, i) {
            ...
            !$.isSm() && g() && (c || l) ? (n.removeClass("open"),
              t.removeClass("visible"),
              r.removeClass("open").removeAttr("style")) : t.slideUp({
              duration: s,
              complete: function () {
                n.removeClass("open"),
          ...
          a.hasClass(e.collapsibleSidebarClass) && (n = void 0 !== t ? t : $(".sidebar-elements > li", o),
            $.each(n, function () {
            ...
            $(".be-toggle-left-sidebar").on("click", function () {
              a.hasClass(e.collapsibleSidebarCollapsedClass) ? (a.removeClass(e.collapsibleSidebarCollapsedClass),
                $("li.open", o).removeClass("open"),
                $("li.active", o).parents(".parent").addClass("active open"),
                $(".be-scroller", o).perfectScrollbar("destroy")) : (a.addClass(e.collapsibleSidebarCollapsedClass),
            ...
            function () {
              ...
              t.on("mouseenter", function () {
                !$.isSm() && a.hasClass(e.collapsibleSidebarCollapsedClass) && $(this).tooltip("show")
              }),
          ...
          u || (l.on("mouseover", function (e) {
            ...
            l.on("touchstart", function (e) {
              var t = $(this)
                , i = t.parent()
                , a = t.next();
              g() && !$.isSm() && (i.hasClass("open") ? m(a, e) : b(this, e),
          ...
          a.hasClass("be-fixed-sidebar") && ($.isSm() && !a.hasClass(e.offCanvasLeftSidebarClass) || d.perfectScrollbar(),
            $(window).resize(function () {
              h(function () {
          ...
          a.hasClass(e.offCanvasLeftSidebarClass) && (e.toggleLeftSidebarButton.on("click", function (t) {
            r && i.hasClass(e.openLeftSidebarClass) ? (i.removeClass(e.openLeftSidebarClass),
              c()) : (i.addClass(e.openLeftSidebarClass + " " + e.transitionClass),
              r = !0),
              t.preventDefault()
          }),
            $(document).on("mousedown touchstart", function (t) {
              $(t.target).closest(o).length || $(t.target).closest(e.toggleLeftSidebarButton).length || !i.hasClass(e.openLeftSidebarClass) || (i.removeClass(e.openLeftSidebarClass),
                c())
            }))
      ...
      e.enableSwipe && a.swipe({
        ...
        swipeLeft: function (t) {
          !r && n.length > 0 && (i.addClass(e.openRightSidebarClass + " " + e.transitionClass),
            r = !0)
        },
        threshold: e.swipeTreshold
      }),
      e.scrollTop && ((f = $('<div class="be-scroll-top"></div>')).appendTo("body"),
...
function FastClick(e, t) {
  ...
  if (t = t || {},
    ...
    for (var a = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], o = 0, n = a.length; o < n; o++)
...
FastClick.prototype.needsClick = function (e) {
  ...
  FastClick.prototype.onTouchEnd = function (e) {
    ...
    if (this.cancelNextClick = !1,
        ...
        this.trackingClick = !1,
        this.trackingClickStart = 0,
      deviceIsIOSWithBadTarget && (n = e.changedTouches[0],
        (r = document.elementFromPoint(n.pageX - window.pageXOffset, n.pageY - window.pageYOffset) || r).fastClickScrollParent = this.targetElement.fastClickScrollParent),
      ...
      return e.timeStamp - i > 100 || deviceIsIOS && window.top !== window && "input" === a ? (this.targetElement = null,
        !1) : (this.focus(r),
        this.sendClick(r, e),
      deviceIsIOS && "select" === a || (this.targetElement = null,
        e.preventDefault()),
        !1);
    return !(!deviceIsIOS || deviceIsIOS4 || !(o = r.fastClickScrollParent) || o.fastClickLastScrollTop === o.scrollTop) || (this.needsClick(r) || (e.preventDefault(),
      this.sendClick(r, e)),
      !1)
  }
  ,
        ...
        this.each(function () {
          ...
          _ || (_ = new function (t, T) {
              ...
              if (!(!0 === Ce.data(x + "_intouch") || e(t.target).closest(T.excludedElements, Ce).length > 0)) {
                ...
                if (!r.pointerType || "mouse" != r.pointerType || 0 != T.fallbackToMouseEvents) {
                  ...
                  return $e = k,
                    ...
                    V(),
                    Z(0, c),
                    !s || Se === T.fingers || T.fingers === b || Y() ? (xe = ne(),
                    2 == Se && (Z(1, s[1]),
                      me = be = ae(Ae[0].start, Ae[1].start)),
                    (T.swipeStatus || T.pinchStatus) && (l = P(r, $e))) : l = !1,
                    !1 === l ? (P(r, $e = C),
                      l) : (T.hold && (Le = setTimeout(e.proxy(function () {
            ...
            function M(t) {
              ...
              if ($e !== w && $e !== C && !Q()) {
                var A, x = S.touches, _ = x ? x[0] : S, M = K(_);
                if (Te = ne(),
                  x && (Se = x.length),
                  T.hold && clearTimeout(Le),
                    $e = y,
                  2 == Se && (0 == me ? (Z(1, x[1]),
                    me = be = ae(Ae[0].start, Ae[1].start)) : (K(x[1]),
                  ...
                  if (he = oe(M.start, M.end),
                      ...
                      k = M.start,
                      $ = M.end,
                      ue = Math.round(Math.sqrt(Math.pow($.x - k.x, 2) + Math.pow($.y - k.y, 2))),
                      ge = ie(),
                      v = ue,
            ...
            function E(e) {
              ...
              return Q() && (Se = Me),
                Te = ne(),
                ge = ie(),
                H() || !O() ? P(i, $e = C) : T.triggerOnTouchEnd || !1 === T.triggerOnTouchEnd && $e === y ? (!1 !== T.preventDefaultEvents && !1 !== e.cancelable && e.preventDefault(),
                  P(i, $e = w)) : !T.triggerOnTouchEnd && U() ? R(i, $e = w, u) : $e === y && P(i, $e = C),
                J(!1),
                null
            }
            ...
            function R(t, s, c) {
              var g;
              if (c == d) {
                if (Ce.trigger("swipeStatus", [s, he || null, ue || 0, ge || 0, Se, Ae, fe]),
                  T.swipeStatus && !1 === (g = T.swipeStatus.call(Ce, t, s, he || null, ue || 0, ge || 0, Se, Ae, fe)))
                  return !1;
                if (s == w && z()) {
                  if (clearTimeout(Fe),
                      clearTimeout(Le),
                      Ce.trigger("swipe", [he, ue, ge, Se, Ae, fe]),
                    T.swipe && !1 === (g = T.swipe.call(Ce, t, he, ue, ge, Se, Ae, fe)))
                    return !1;
                  switch (he) {
                    case i:
              ...
              if (c == p) {
                if (Ce.trigger("pinchStatus", [s, ye || null, ke || 0, ge || 0, Se, ve, Ae]),
                  T.pinchStatus && !1 === (g = T.pinchStatus.call(Ce, t, s, ye || null, ke || 0, ge || 0, Se, ve, Ae)))
                  return !1;
                if (s == w && N())
                  switch (ye) {
                    case r:
              ...
              return c == u ? s !== C && s !== w || (clearTimeout(Fe),
                clearTimeout(Le),
                X() && !G() ? (Ee = ne(),
                  Fe = setTimeout(e.proxy(function () {
                    Ee = null,
                      Ce.trigger("tap", [t.target]),
                    T.tap && (g = T.tap.call(Ce, t, t.target))
                  }, this), T.doubleTapThreshold)) : (Ee = null,
                  Ce.trigger("tap", [t.target]),
                T.tap && (g = T.tap.call(Ce, t, t.target)))) : c == h ? s !== C && s !== w || (clearTimeout(Fe),
                clearTimeout(Le),
                Ee = null,
                Ce.trigger("doubletap", [t.target]),
              T.doubleTap && (g = T.doubleTap.call(Ce, t, t.target))) : c == f && (s !== C && s !== w || (clearTimeout(Fe),
                Ee = null,
            ...
            function J(e) {
              Ce && (!0 === e ? (Ce.bind(se, M),
                Ce.bind(ce, E),
              de && Ce.bind(de, L)) : (Ce.unbind(se, M, !1),
                Ce.unbind(ce, E, !1),
              de && Ce.unbind(de, L, !1)),
  ...
  function (e) {
    function t(i, a) {
      ...
      var o, n, r, l, s, c, d, p, u, h, f, g = (n = {
        ...
        d = !1,
        p = !1,
      "string" == typeof (o = i) && (o = function (e) {
      ...
      "object" == typeof o && (T(o.r) && T(o.g) && T(o.b) ? (u = o.r,
        h = o.g,
        f = o.b,
        n = {
          r: 255 * y(u, 255),
        ...
        d = !0,
        p = "%" === String(o.r).substr(-1) ? "prgb" : "rgb") : T(o.h) && T(o.s) && T(o.v) ? (l = S(o.s),
        s = S(o.v),
        n = function (t, i, a) {
          t = 6 * y(t, 360),
            i = y(i, 100),
        ...
        d = !0,
        p = "hsv") : T(o.h) && T(o.s) && T(o.l) && (l = S(o.s),
        c = S(o.l),
        n = function (e, t, i) {
          function a(e, t, i) {
            return 0 > i && (i += 1),
    ...
    function i(e, t, i) {
      e = y(e, 255),
        t = y(t, 255),
        i = y(i, 255);
      var a, o, n = D(e, t, i), r = L(e, t, i), l = (n + r) / 2;
      if (n == r)
        a = o = 0;
      else {
        var s = n - r;
        switch (o = l > .5 ? s / (2 - n - r) : s / (n + r),
          n) {
          case e:
            a = (t - i) / s + (i > t ? 6 : 0);
            break;
    ...
    function a(e, t, i) {
      e = y(e, 255),
        t = y(t, 255),
        i = y(i, 255);
      var a, o, n = D(e, t, i), r = L(e, t, i), l = n, s = n - r;
      if (o = 0 === n ? 0 : s / n,
        n == r)
        a = 0;
      else {
    ...
    function v(e, i) {
      i = i || 6;
      for (var a = t(e).toHsv(), o = a.h, n = a.s, r = a.v, l = [], s = 1 / i; i--;)
        l.push(t({
          h: o,
          s: n,
          v: r
    ...
    t.prototype = {
      ...
      toString: function (e) {
        ...
        return !t && a && ("hex" === e || "hex6" === e || "hex3" === e || "hex4" === e || "hex8" === e || "name" === e) ? "name" === e && 0 === this._a ? this.toName() : this.toRgbString() : ("rgb" === e && (i = this.toRgbString()),
      ...
      t.mostReadable = function (e, i, a) {
        ...
        for (var d = 0; d < i.length; d++)
          (o = t.readability(e, i[d])) > c && (c = o,
            s = t(i[d]));
        return t.isReadable(e, s, {
          level: r,
          size: l
        }) || !n ? s : (a.includeFallbackColors = !1,
  ...
  App = function () {
    ...
    return App.charts = function () {
      ...
      i = tinycolor(App.color.primary).lighten(5).toString(),
        ...
        t("line-chart3", 60),
        a = App.color.success,
        o = tinycolor(App.color.success).lighten(22).toString(),
        $.plot($("#bar-chart2"), [{
        ...
        p = tinycolor(App.color.warning).brighten(3).toString(),
        $.plot($("#bar-chart1"), [{
        ...
        t("bar-chart1", 60),
        u = tinycolor(App.color.success).lighten(7).toString(),
        h = App.color.success,
    ...
    return App.IconsFilter = function () {
      ...
      i.each(function (t, i) {
        ...
        a.on("keyup", function () {
          ...
          if ("all" == o.val() ? i.show() : $("#" + o.val()).show(),
              n) {
    ...
    return App.megaMenu = function () {
      ...
      $(".be-sub-header .nav-link, .be-sub-header .dropdown-item", e).on("click", function (e) {
        ...
        $.isSm() ? (n.length && (a.hasClass("open") ? l(n) : function (e) {
          ...
          e.preventDefault()),
          e.stopPropagation()) : a.parent().hasClass("navbar-nav") && n.length && (o.removeClass("open"),
          a.addClass("open"),
          e.preventDefault())
      }),
        $(window).resize(function () {
